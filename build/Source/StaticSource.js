...
var StaticSource = /*#__PURE__*/function (_Source) {
  _inherits(StaticSource, _Source);

  var _super = _createSuper(StaticSource);

  /**
   * @param {string} message The message to respond with
   * @param {string[]} tags  The tags to respond to
   */
  function StaticSource(message, tags) {
    var _this;

    _classCallCheck(this, StaticSource);

    _this = _super.call(this, tags);
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                return _context.abrupt("return", this.message);
